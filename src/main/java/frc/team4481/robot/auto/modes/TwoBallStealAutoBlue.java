...
public class TwoBallStealAutoBlue extends AutoModeBase {
    String path1 = "1B_STEAL_PATH1";
    String path15 = "2B_STEAL_ALT_PATH1.5";
    String path2 = "2B_STEAL_ALT_PATH2";
    String path3 = "2B_STEAL_ALT_PATH3";
    String path4 = "2B_STEAL_ALT_PATH4";
