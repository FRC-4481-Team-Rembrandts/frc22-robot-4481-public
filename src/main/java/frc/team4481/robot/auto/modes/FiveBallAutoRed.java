...
public class FiveBallAutoRed extends AutoModeBase {
    String path1 = "5B_RED_PATH1";
    String path2 = "5B_RED_PATH2";
    String path3 = "5B_RED_PATH3";
    String path4 = "5B_RED_PATH4";
    String path5 = "5B_RED_PATH5";
